...
export default function CTASection() {
  ...
  return (
    <section className="relative py-40 flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        <blockquote className="text-3xl md:text-6xl font-black italic text-[#e21b1b] uppercase tracking-wider drop-shadow-[0_3.5px_0px_#2b59c3] px-4 max-w-5xl leading-none">
        ...
        <div className="relative group">
          ...
          <button
            onClick={() => { setIsPopping(true); setTimeout(() => setIsPopping(false), 450); }}
          ...
          >
            <span className="flex items-center gap-2.5 text-xs md:text-sm">
              ...
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path d="M13 5l7 7-7 7M5 5l7 7-7 7" /></svg>
            </span>
          </button>
        </div>
      </div>
